  ...
  return (
    <div className="fixed z-50 h-20 w-screen bottom-0 border border-gray-200 dark:border-gray-600" style={{background: 'linear-gradient(to right, darkblue, darkmagenta)'}}>
        ...
        <button
          ...
          onClick={() => handleTooltipToggle('tooltipHome')}
        >
          <svg
        ...
        <button
          ...
          onClick={() => handleTooltipToggle('tooltipWallet')}
        >
          <svg
            className="w-5 h-5 mb-1 text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500"
            aria-hidden="true"
        ...
        <div
          ...
          className={`absolute z-10 ${
            tooltipVisibility['tooltipWallet'] ? 'visible opacity-100' : 'invisible opacity-0' } inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-sm tooltip dark:bg-gray-700`}
            >
              Wallet
            ...
            <div className="flex items-center justify-center">
              <button
                ...
                onClick={() => handleTooltipToggle('tooltipNew')}
              >
                <svg
            ...
            <div
              ...
              role="tooltip"
              className={`absolute z-10 ${
                tooltipVisibility['tooltipNew'] ? 'visible opacity-100' : 'invisible opacity-0'
            ...
            <button
              ...
              type="button"
              className="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group"
              onClick={() => handleTooltipToggle('tooltipSettings')}
            >
              <svg
                className="w-5 h-5 mb-1 text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500"
                aria-hidden="true"
            ...
            <div
              ...
              role="tooltip"
              className={`absolute z-10 ${
                tooltipVisibility['tooltipSettings'] ? 'visible opacity-100' : 'invisible opacity-0'
              } inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-sm tooltip dark:bg-gray-700`}
            >
              Settings
              <div className="tooltip-arrow" data-popper-arrow></div>
            ...
            <button
              ...
              onClick={() => handleTooltipToggle('tooltipProfile')}
            >
              <svg
                className="w-5 h-5 mb-1 text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500"
                aria-hidden="true"
        ...
        <div
          ...
          role="tooltip"
          className={`absolute z-10 ${
            tooltipVisibility['tooltipProfile'] ? 'visible opacity-100' : 'invisible opacity-0'
          } inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-sm tooltip dark:bg-gray-700`}
        >
          Profile
          <div className="tooltip-arrow" data-popper-arrow></div>
